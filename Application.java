...
public class Application extends PApplet {
	...
	/**
	 * layer currently selected in the GUI
	 */
	public int currentLayer = 0;
	
	/**
	 * Used as identifier when running multiple instances
	 */
	...
	public void setup() {
		...
		// controllers setups
		// need to make the controller synchronised when gui is in main window
